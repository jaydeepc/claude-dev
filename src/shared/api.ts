...
export const bedrockDefaultModelId: BedrockModelId = "anthropic.claude-3-sonnet-20240620-v1:0"
...
export const openRouterDefaultModelId: OpenRouterModelId = "anthropic/claude-3-sonnet:beta"
